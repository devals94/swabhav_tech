...
public class Inventory {
	...
	public Guitar getGuitars(String serialNumber) {
		/*
		 * for (Iterator i = guitars.iterator(); i.hasNext();) { Guitar guitar =
		 * (Guitar) i.next(); if (guitar.getSerialNumber().equals(serialNumber))
		 * { return guitar; } }
		 */

		for (Guitar gui : guitars) {
			if (gui.getSerialNumber().equals(serialNumber)) {
				return gui;
			}
		}
		return null;
